...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="<?= e(BASE_URL) ?>/client/" class="nav-item <?= $current === 'index.php' ? 'active' : '' ?>">
            <i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a>
        <a href="<?= e(BASE_URL) ?>/client/chat.php" class="nav-item <?= $current === 'chat.php' ? 'active' : '' ?>">
            <i class="fas fa-comments"></i><span>Chat</span></a>
        <a href="<?= e(BASE_URL) ?>/client/video_call.php" class="nav-item <?= $current === 'video_call.php' ? 'active' : '' ?>">
            <i class="fas fa-video"></i><span>Video Calls</span></a>
        <a href="<?= e(BASE_URL) ?>/client/projects.php" class="nav-item <?= $current === 'projects.php' ? 'active' : '' ?>">
            <i class="fas fa-project-diagram"></i><span>Projects</span></a>
        <a href="<?= e(BASE_URL) ?>/client/tasks.php" class="nav-item <?= $current === 'tasks.php' ? 'active' : '' ?>">
            <i class="fas fa-clipboard-list"></i><span>Tasks</span></a>
        <a href="<?= e(BASE_URL) ?>/client/invoices.php" class="nav-item <?= $current === 'invoices.php' ? 'active' : '' ?>">
            <i class="fas fa-file-invoice-dollar"></i><span>Invoices</span></a>
        <a href="<?= e(BASE_URL) ?>/client/email.php" class="nav-item <?= $current === 'email.php' ? 'active' : '' ?>">
            <i class="fas fa-envelope"></i><span>Email</span></a>
        <a href="<?= e(BASE_URL) ?>/client/profile.php" class="nav-item <?= $current === 'profile.php' ? 'active' : '' ?>">
